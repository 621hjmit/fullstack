	...
	<div class="editorial-common">
		...
		<div class="ng-star-inserted">
			<section class="block_hero_media">
				<img src="/static/main_images/section2.webp" alt=""
					class="hide-in-mobile"> <img
					src="/static/main_images/section2.png" alt=""
		...
		<div class="block-media ">
			<ul id="productList" class="grid-plate set4by1 set-mobile-2by2"></ul>
		</div>
		<div class="ng-star-inserted">
			<section class="block-text">
		...
		<div class="ng-star-inserted">
			<section class="block_hero_media">
				<img src="/static/main_images/section4.webp" alt=""
					class="hide-in-mobile"> <img
					src="/static/main_images/section4.png" alt=""
					class="show-in-mobile">
			</section>
		</div>
		<div class="parent-of-block-without-text ng-star-inserted">
		...
		<div class="block-media">
			<ul id="productList" class="grid-plate set4by1 set-mobile-2by2">
				<!-- 여기에서 JavaScript가 동적으로 제품 목록을 추가할 것입니다 -->
			</ul>
		</div>
	</div>
	<!-- .editorial-common -->
...
<script src='/static/js/product/index.js' defer></script>
