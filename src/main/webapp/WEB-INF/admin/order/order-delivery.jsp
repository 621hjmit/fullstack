...
<!-- [ block1 : search conditions ] start -->			
			<%@ include file="/WEB-INF/admin/order/order-delivery-searchconditions.jsp" %>
...
<!-- [ block3-2 : buttons ] start -->
			<div class="mb-3">
				<button type="button" class="btn btn-outline-danger btn-sm" onclick="prepareDelivery()">배송준비중처리</button>
				<button type="button" class="btn btn-outline-danger btn-sm" onclick="onDelivery()">배송중처리</button>
				<button type="button" class="btn btn-outline-danger btn-sm" onclick="completeDelivery()">배송완료처리</button>
				<button type="button" class="btn btn-outline-danger btn-sm" onclick="holdDelivery()">배송보류처리</button>
			</div>
<!-- [ block3-2 : buttons ] end -->
<!-- [ block3-3 : summary ] start -->				
			<div class="mb-2 d-flex justify-content-between align-items-center">
				<div class="flex-grow-1">
				[조회된 주문건수 총 <span id="searchResults">0</span>건]
				</div>
<!-- [ block3-3 : summary ] end -->	
<!-- [ block3-4 : sorting ] start -->
...
<!-- [Page Specific JS] start ------------------------------------------------------------------------------>
	...
	<script src="/static/js/admin/order/order-delivery.js"></script>
