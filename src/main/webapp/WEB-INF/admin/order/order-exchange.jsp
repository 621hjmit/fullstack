...
<!-- [ block1 : search conditions ] start -->			
			<%@ include file="/WEB-INF/admin/order/order-exchange-searchconditions.jsp" %>
...
<!-- [ block3-1 : title ] start -->
			<h4 class="mb-2 pt-2 "><b>교환 주문 목록</b></h4>
<!-- [ block3-1 : title ] end -->
<!-- [ block3-2 : buttons ] start -->
			<div class="mb-3">
				<button type="button" class="btn btn-outline-danger btn-sm">교환처리</button>
			</div>
...
<!-- [Page Specific JS] start ------------------------------------------------------------------------------>
	...
	<script src="/static/js/admin/order/order-exchange.js"></script>
