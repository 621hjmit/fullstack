...
<!-- [ block1 : search conditions ] start -->			
			<%@ include file="/WEB-INF/admin/order/order-return-searchconditions.jsp" %>
...
<!-- [ block3-1 : title ] start -->
			<h4 class="mb-2 pt-2 "><b>반품 주문 목록</b></h4>
<!-- [ block3-1 : title ] end -->
			<div class="mb-3">
				<button type="button" class="btn btn-outline-danger btn-sm">반품처리</button>
				<button type="button" class="btn btn-outline-danger btn-sm">주문취소</button>
			</div>
<!-- [ block3-2 : summary ] start -->				
			<div class="mb-2 d-flex justify-content-between align-items-center">
				<div class="flex-grow-1">
				[환불 주문건수 총 <span id="searchResults">0</span>건]
				</div>
...
<!-- [Page Specific JS] start ------------------------------------------------------------------------------>
	...
	<script src="/static/js/admin/order/order-return.js"></script>
