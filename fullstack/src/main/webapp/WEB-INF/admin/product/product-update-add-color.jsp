				...
				<div class="card table-card">
					<div class="card-body" style="padding: 0px;">
						<table class="table">
							<tr>
								<th class="text-center col-sm-2"
									style="border-right: 1px solid #ccc;">카테고리</th>
								<td>
									<div class="d-flex">
										<div class="col-sm-4">
											<input type="text" class="form-control"
												id="mainCategoryInput" readonly>
										</div>
										...
										<div class="col-sm-4 ms-2">
											<input type="text" class="form-control"
												id="detailCategoryInput" readonly>
										</div>
									</div>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										<textarea class="form-control me-2" rows="3" id="piStory"
											readonly></textarea>
									</div>
								</td>
							</tr>
							...
							<tr>
								<th colspan="2" class="text-center"
									...
									<button id="duplicateProductButton" class="btn btn-primary">새로운
										제품으로 등록</button>
								</th>
							</tr>
						</table>
...
<script src='/static/js/product/product-update-add-color.js' defer></script>
