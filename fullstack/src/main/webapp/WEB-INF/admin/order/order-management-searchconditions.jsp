...
<!---------------------------------------------- common ------------------------------------------------------>														
							...
							<form class="row row-cols-md-auto g-1 align-items-center">
								<div class="col-12">
									<div class="form-check-inline">
										<input class="form-check-input conditions" type="radio" name="deliveryStatus" value="5" id="radio5">
							...
							<form class="row row-cols-md-auto g-1 align-items-center">
								<div class="col-12">
									<div class="form-check-inline">
										<input class="form-check-input conditions" type="radio" name="csStatus" value="10" id="radio10">
										<label for="radio10">취소</label>
									</div>
									<div class="form-check-inline">
										<input class="form-check-input conditions" type="radio" name="csStatus" value="11" id="radio11">
										<label for="radio11">교환</label>
									</div>
									<div class="form-check-inline">
										<input class="form-check-input conditions" type="radio" name="csStatus" value="12" id="radio12">
										<label for="radio12">반품</label>
									</div>
									<div class="form-check-inline">
										<input class="form-check-input conditions" type="radio" name="csStatus" value="13" id="radio13">
										<label for="radio13">환불</label>
									</div>
								</div>
							</form> -->
						</div>
